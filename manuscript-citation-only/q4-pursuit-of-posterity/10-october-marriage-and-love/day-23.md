...
*A good marriage shouldn't keep hitting the same friction over and over* was the assumption underneath Bruce's frustration, that recurring conflict was proof of a flaw somewhere rather than something a marriage was actually supposed to do something with. James names a different function for exactly this kind of repeated difficulty. In James 1:2-4, he tells believers to consider it pure joy whenever they face trials of every kind, because the testing of their faith builds endurance, and that endurance, left to finish its work, will make them mature and complete, lacking nothing. James is describing the kind of trial that keeps showing back up, doing its slow work on a man's character precisely because it doesn't resolve and get shelved after one round.
