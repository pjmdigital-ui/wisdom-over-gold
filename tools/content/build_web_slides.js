...
const VIDEOS = [
  {
    ...
    slides: [
      ...
      { headline: "He almost felt guilty for feeling it.", body: "What right did he have to feel unsettled with a life that good? But the ache wasn’t asking his permission — it had been there through the lean years and the good ones alike, unmoved by how things were actually going." },
      { headline: "The psalmist felt this exact thing — and he wasn’t writing from a collapsed life.", body: "Psalm 42 reaches for thirst, a bodily need: “As a hart longs for flowing streams, so longs my soul for thee, O God. My soul thirsts for God, for the living God.” Scholars place it in a season of real distance, real longing — not a life falling apart. The ache shows up whether or not anything around you is actually wrong." },
      { headline: "You can fix your whole life and it stays exactly where it was.", body: "Marriage, finances, health — solve them one at a time, completely, and the ache doesn’t move. It’s the God-shaped space every man carries, rich or broke, thriving or barely holding on. Good circumstances just quiet the noise around it. They were never built to fill it." },
      { headline: "The ache isn’t broken. It’s doing exactly what it’s supposed to do.", body: "It’s not a symptom to fix — it’s pointing you somewhere the lawn chair and the sprinkler were never going to be able to reach. That Sunday afternoon wasn’t a problem. It was an invitation." },
      { headline: "Here’s what to actually do with it.", body: "The next time you feel that ache in a good moment, not just a hard one — don’t reach for a distraction. Sit with it for sixty seconds and say out loud, “God, I know this is You.”" },
      { headline: "Then read something called a List of Truths.", body: "Not generic positivity — specific, provable things: what you’ve overcome, what you’ve stayed faithful to, what God has actually done in your life. David did this before Goliath — he remembered the lion and the bear before he faced the giant. Write fifteen lines like it, and keep them where you’ll actually see them." },
