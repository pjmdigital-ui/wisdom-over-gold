...
(async () => {
  ...
  await page.mouse.click(1267, 308);
  await page.waitForTimeout(2000);
  await page.mouse.click(1332, 396);
  await page.waitForTimeout(2000);
  await page.mouse.click(852, 497);
  await page.waitForTimeout(1200);
  await page.mouse.click(748, 561);
  await page.waitForTimeout(1200);
  await page.mouse.click(852, 585);
  await page.waitForTimeout(1200);
  await page.mouse.click(761, 624); // the "@ 7" price option
  await page.waitForTimeout(1000);

  await page.mouse.click(852, 691); // Product name field
  await page.keyboard.type("Seek First: The Four Pursuits of the Modern Catholic Man");
  await page.waitForTimeout(300);
  await page.screenshot({ path: "screenshots/sp-08-ready-to-save.png", fullPage: true });

  await page.mouse.click(1103, 878); // Save
  await page.waitForTimeout(2500);
  await page.screenshot({ path: "screenshots/sp-09-final-saved.png", fullPage: true });

  await context.close();
})().catch((err) => {
  console.error("ADD_STEP_PRODUCT5_ERROR", err);
  process.exit(1);
});
