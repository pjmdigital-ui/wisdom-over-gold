...
(async () => {
  ...
  await page.mouse.click(388, 836);
  await page.waitForTimeout(3000);
  await page.mouse.click(719, 301);
  await page.waitForTimeout(2000);
  await page.mouse.click(719, 371);
  await page.waitForTimeout(1200);
  await page.mouse.click(580, 411); // "Form 0" option
  await page.waitForTimeout(1500);
  await page.screenshot({ path: "screenshots/af-07-form0-selected.png", fullPage: false });

  await page.mouse.click(896, 317); // close Form Picker modal (X)
  await page.waitForTimeout(1000);
  await page.screenshot({ path: "screenshots/af-08-modal-closed.png", fullPage: false });

  // Save the page
  await page.mouse.click(1305, 25);
  await page.waitForTimeout(3000);
  await page.screenshot({ path: "screenshots/af-09-page-saved.png", fullPage: false });

  await context.close();
})().catch((err) => {
  console.error("PB_FINALIZE_FORM_ERROR", err);
  process.exit(1);
});
