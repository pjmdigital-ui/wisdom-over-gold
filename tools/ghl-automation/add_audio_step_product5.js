...
(async () => {
  ...
  await page.mouse.click(686, 536);
  await page.waitForTimeout(1200);
  await page.mouse.click(852, 585);
  await page.waitForTimeout(1200);
  await page.mouse.click(698, 624);
  await page.waitForTimeout(1000);

  await page.mouse.click(1103, 861); // Save
  await page.waitForTimeout(2500);
  await page.screenshot({ path: "screenshots/sp-19-both-products-saved.png", fullPage: true });

  await context.close();
})().catch((err) => {
  console.error("ADD_AUDIO_STEP_PRODUCT5_ERROR", err);
  process.exit(1);
});
