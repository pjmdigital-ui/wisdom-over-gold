...
(async () => {
  ...
  await page.mouse.click(1373, 497);
  await page.waitForTimeout(1200);
  await page.mouse.click(1338, 462);
  await page.waitForTimeout(1500);

  await page.mouse.click(719, 570);
  await page.keyboard.type("DELETE");
  await page.waitForTimeout(400);
  await page.mouse.click(912, 632);
  await page.waitForTimeout(2000);
  await page.screenshot({ path: "screenshots/sp-14-deleted.png", fullPage: true });

  await context.close();
})().catch((err) => {
  console.error("DELETE_DUP_PRODUCT3_ERROR", err);
  process.exit(1);
});
